            ...
            <div className="text-center mt-24">
                <div className="inline-block border-2 p-6 rounded-lg">
                    ...
                    <div className="flex justify-center gap-3">
                        <button className="border px-3 py-2 text-center rounded-2xl focus:bg-red-950 focus:text-white" onClick={() => {
                            setFillter("all")
                        }} >All</button>
                        <button className="border px-3 py-2 text-center rounded-3xl focus:bg-red-950 focus:text-white" onClick={() => {
                            setFillter("pending")
                        }}>Pending</button>
                        <button className="border px-3 py-2 text-center rounded-3xl focus:bg-red-950 focus:text-white" onClick={() => {
                            setFillter("complete")
                    ...
                    <div className="mt-6 relative overflow-x-auto shadow-md sm:rounded-lg">
                        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                {tasks.length === 0 
                                    ?(<tr><td colSpan="3" className="text-center py-4 text-gray-500">No tasks added yet.</td></tr>)
